  ...
  const checkBought = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://recipe-sell.onrender.com/checkBought",
        {
    ...
    try {
      if (
        ...
        try {
          const signerAddress = await signer.getAddress();
          const response = await axios.post(
            "https://recipe-sell.onrender.com/buy",
            {
              signer: signerAddress,
              username,
              id,
          ...
          <div className="flex">
            <div className="max-w-[300px] max-h-[500px] mt-8 mr-6">
              <img
                ...
                src={`https://recipe-sell.onrender.com${currData[0].image?.filePath}`}
            ...
            <div className="w-full flex-grow relative mt-10">
              ...
              <div className="mb-4">
                ...
                {currData[0].allergents &&
                  currData[0].allergents.length > 0 && (
                    <div className="mb-4">
                      <h3 className="font-semibold text-lg text-gray-900">
                        Allergents:
                      </h3>
                ...
                {currentUser == "chef" ? (
                  ...
                  <button
                    className={
                      buyToogle && ButtonProductId === id
                        ? "mt-4 bg-green-500 text-white px-4 py-2 rounded-lg"
