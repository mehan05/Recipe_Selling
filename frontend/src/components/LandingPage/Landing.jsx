      ...
      <section className="">
        <div className="flex justify-center relative mt-6 items-center">
          <div className=" absolute top-5">
            <h1 className=" text-3xl underline underline-offset-4 font-semibold">
              🍿Recipe_Mart 🍿
            </h1>
          </div>
          <div
            onClick={handleConnect}
            className="  absolute top-5 right-5 border-2 border-red-500 shadow-lg shadow-red p-4 rounded-xl hover:bg-red-500 hover:text-white hover:border-dashed hover:border-2 hover:border-white hove:transition-transform duration-300 "
          >
            <button className=" font-semibold text-lg">
              {walletAddress
                ? walletAddress?.slice(0, 4) +
                  "..." +
                  walletAddress?.slice(39, 42)
                : "Connect Wallet"}
            </button>
          </div>
        </div>
          ...
          <header>
            <div className="border-2 m-3 p-4 border-red-600 rounded-xl text-lg">
              ...
              <p className="mt-4 w-full text-black">
                Join our culinary marketplace where chefs and food lovers can
                buy and sell unique, handcrafted recipes. Whether you're looking
                to try something new or share your creations with the world,
